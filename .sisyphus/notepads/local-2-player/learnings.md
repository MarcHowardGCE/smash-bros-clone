...
- 2026-08-05 audit: local 2-player plan compliance check found server files unchanged vs HEAD~1 and local mode wired through main.ts with shared camera/UI hooks.
